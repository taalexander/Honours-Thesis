...
\end{equation*}
\begin{equation}
= \int \limits_\Phi \int \limits_T \left[(\frac{1}{2}+b)+\frac{A}{2}cos(\Delta\phi + C\delta + \frac{\alpha b_{water}\Phi\delta}{RT}\times 10^{h_A - \frac{h_B}{h_C - T}}\right]P(T|\hat{T})P(\Phi|\hat{\Phi})dTd\Phi
\label{eq:finalmodel}
\end{equation}
\normalsize
